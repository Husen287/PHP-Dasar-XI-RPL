            ...
            <div class="row">
                <div class="kiri col-lg-4">
                 ...
                 <div class="kanan col-lg-8">
                     ...
                     <small>admin lembur boss</small>
                     <div class="col-12 py-3">
                         <small>pengajar jurusan : </small><br>
                         <span class="badge text-bg-primary">ngaji</span>
                         <span class="badge text-bg-danger">main game</span>
                         <span class="badge text-bg-warning">rajin sekolah</span>
                     </div>
                     <div class="row">
                         <div class="col-8">
